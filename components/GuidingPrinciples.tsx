      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch">
          {principles.map((principle, index) => (
            <div key={index} className="flip-card-container" tabIndex={0} role="group" aria-label={`${principle.title} - ${principle.label}`}>
              <div className="flip-card-inner">
                ...
                <div className={`flip-card-back ${principle.backBg} ${principle.label !== 'MOTTO' ? 'border border-structural-gray-blue' : ''} relative overflow-hidden`}>
                  ...
                  <div className={`absolute -bottom-10 -right-10 opacity-[0.03] ${principle.label === 'MOTTO' ? 'opacity-[0.06]' : ''}`}>
                    <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={0.5} stroke="currentColor" className="w-48 h-48">
                  ...
                  <div className="relative z-10">
                    ...
                    {principle.label === 'MOTTO' ? (
                      <>
                        <h3 className="text-xs uppercase tracking-[0.2em] text-white/80 mb-6">{principle.title}</h3>

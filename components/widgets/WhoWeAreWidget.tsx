...
export default function WhoWeAreWidget({ items }: { items: WhoWeAreItem[] }) {
  ...
  return (
    <section className="bg-structural-light-gray py-16 sm:py-20 -mx-4 sm:-mx-6 lg:-mx-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-xl overflow-hidden">
          <div className="grid grid-cols-1 lg:grid-cols-2">
            ...
            <div className="p-6 lg:border-r border-structural-gray-blue">
              <h3 className="font-sans text-xl font-bold text-text-dark mb-4">
              ...
              <div className="relative bg-structural-gray-blue rounded-lg overflow-hidden aspect-video flex items-center justify-center">
            ...
            <div className="p-6">
              ...
              <div className="space-y-3">
                {items.map((item, index) => (
                  <div key={index} className="border border-structural-gray-blue rounded-lg overflow-hidden">
                    <button
                      onClick={() => toggleAccordion(index)}
                      className="w-full flex items-center justify-between p-4 bg-structural-light-gray hover:bg-structural-gray-blue transition-colors"
                    >
                    ...
                    {openAccordion === index && (
                      <div className="p-4 bg-white border-t border-structural-gray-blue">

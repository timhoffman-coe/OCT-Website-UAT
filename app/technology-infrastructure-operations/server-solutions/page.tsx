...
export default async function ServerSolutionsPage() {
  const data = (await fetchPortfolioSubpage('/technology-infrastructure-operations/server-solutions')) || fallback;

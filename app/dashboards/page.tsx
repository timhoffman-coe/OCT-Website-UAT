...
export default function DashboardsPage() {
  return (
    <div className="bg-white min-h-screen">
      ...
      <main id="main-content" className="max-w-screen-2xl mx-auto py-12 md:py-16 px-4 sm:px-6 lg:px-8">
          ...
          {dashboards.map((dashboard, index) => (
            ...
            >
              ...
              <div className="mt-auto pt-4 border-t border-structural-gray-blue text-process-blue font-bold text-sm flex items-center justify-between">
                ...
                <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-4 h-4 group-hover:translate-x-1 transition-transform">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-3 gap-12 border-t border-structural-gray-blue pt-16">
          ...
          <aside className="bg-structural-light-gray p-8 rounded-2xl h-fit">
            ...
            <div className="space-y-4">
              ...
              >
                <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 text-process-blue flex-shrink-0">

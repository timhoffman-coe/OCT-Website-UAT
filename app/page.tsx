...
export default function Home() {
  ...
  return (
    <div className="bg-white">
          ...
          <aside className="lg:col-span-4">
            <div className="bg-structural-light-gray rounded-2xl p-8 sticky top-28">
              ...
              <div className="space-y-2">
                <Link href="/get-help" className="flex items-center justify-between p-4 bg-white rounded-lg hover:shadow-md transition-all group">
                  <div className="flex items-center gap-3">
                    <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5 text-text-secondary group-hover:text-process-blue transition-colors">
                  ...
                  <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4 text-text-secondary">
      ...
      {/* Quick Metrics Bar */}
      <section className="w-full bg-structural-light-gray border-t border-structural-gray-blue">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-4 divide-y md:divide-y-0 md:divide-x divide-structural-gray-blue">
            <div className="flex flex-col items-center justify-center text-center px-4 py-4 md:py-0">
              <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8 text-process-blue mb-3">
                <path strokeLinecap="round" strokeLinejoin="round" d="M7.5 21 3 16.5m0 0L7.5 12M3 16.5h13.5m0-13.5L21 7.5m0 0L16.5 12M21 7.5H7.5" />
              </svg>
              <p className="text-3xl font-black text-dark-blue mb-1">10,000+</p>
              <p className="text-[10px] uppercase tracking-[0.2em] font-bold text-text-secondary">Endpoints Maintained</p>
            </div>
            <div className="flex flex-col items-center justify-center text-center px-4 py-4 md:py-0">
              <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8 text-process-blue mb-3">
                <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193-.34.027-.68.052-1.02.072v3.091l-3-3c-1.354 0-2.694-.055-4.02-.163a2.115 2.115 0 0 1-.825-.242m9.345-8.334a2.126 2.126 0 0 0-.476-.095 48.64 48.64 0 0 0-8.048 0c-1.131.094-1.976 1.057-1.976 2.192v4.286c0 .837.46 1.58 1.155 1.951m9.345-8.334V6.637c0-1.621-1.152-3.026-2.76-3.235A48.455 48.455 0 0 0 11.25 3c-2.115 0-4.198.137-6.24.402-1.608.209-2.76 1.614-2.76 3.235v6.226c0 1.621 1.152 3.026 2.76 3.235.577.075 1.157.14 1.74.194V21l4.155-4.155" />
              </svg>
              <p className="text-3xl font-black text-dark-blue mb-1">24/7</p>
              <p className="text-[10px] uppercase tracking-[0.2em] font-bold text-text-secondary">Support Availability</p>
            </div>
            <div className="flex flex-col items-center justify-center text-center px-4 py-4 md:py-0">
              <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8 text-process-blue mb-3">
              ...
              <p className="text-3xl font-black text-dark-blue mb-1">99.9%</p>
              <p className="text-[10px] uppercase tracking-[0.2em] font-bold text-text-secondary">System Uptime</p>
            </div>
          </div>
        </div>
      </section>
